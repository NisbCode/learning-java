package Estudando.javacore.ZZLstreamsparalelos.teste;
 ...
 * então, é necessário você tomar algumas medidas antes de resolver usar:
 ...
 * - Desempenho de Streams paralelas em coleções (do melhor para o pior):
 ...
 * - Considerar o processamento do merge, ou seja, se vai demorar  pra juntar(Join) as operações que foram quebradas(Que houve um fork)
 */
...
public class StreamsParalelosTeste {
    public static void main(String[] args) {
        ...
        somaParallelStreamsIterate(numeroLong);

        // É possível você ver quantos processadores disponiveis pro paralelismo você tem
        ...
        somaRangeClosedStreams(numeroLong);

        // E, ainda, usando paralelismo nele
        somaRangeClosedStreamsParallels(numeroLong);

        /**
         * No fim a operação que levou menos tempo foi o forSoma,
         * mas há casos em que as Streams Paralelas vão ser bem úteis, normalmente quando houver trabalhos grandes
         */
    }
    ...
    private static void somaStreamsIterate(long numero){
        System.out.println("Dentro do Streams (que é sequencial)");
        long resultado = 0;
        long tempoInicial = System.currentTimeMillis();
    ...
    private static void somaParallelStreamsIterate(long numero){
        System.out.println("Dentro do Streams Paralelos");
        long resultado = 0;
        long tempoInicial = System.currentTimeMillis();
        resultado = Stream.iterate(1L, i -> i + 1)
                .limit(numero)
    ...
    private static void somaRangeClosedStreams(long numero){
    ...
    private static void somaRangeClosedStreamsParallels (long numero){
