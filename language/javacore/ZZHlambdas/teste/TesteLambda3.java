...
import Estudando.javacore.ZZHlambdas.classe.ComparadorCarro;
...
public class TesteLambda3 {
    public static void main(String[] args) {
        ...
        List<Carro> listaCarros = asList(new Carro("Amarelo", 1985), new Carro("Prata", 1968), new Carro("Ferrugem", 2016));
