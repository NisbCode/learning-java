 ...
 * além disso, as iteraçõees em Streams são internas (não precisam de for)
 */

public class StreamTeste {
    // Pegar os 3 primeiros nomes das pessoa com menos de 25 anos
    // Ordenados pelo nome
    public static void main(String[] args) {
        ...
        // Até o collect(), apareceram métodos stream, ou seja, métodos que retornavam outras streams,
