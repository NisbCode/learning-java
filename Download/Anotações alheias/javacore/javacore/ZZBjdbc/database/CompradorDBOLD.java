...
public class CompradorDBOLD {
    ...
    public static void saveTransaction() {
        ...
        try {
            // Desativando o AutoCommit, que faz com que as instruções
    ...
    public static void updateRowSet (Comprador comprador) {
        ...
        try {
            // ce da o comando
            jrs.setCommand(sql);
            // ce substitui o wildcard
            jrs.setInt(1, comprador.getId());
            // ce executa o comando
            jrs.execute();
            // ce vai andar pra primeira posição
            jrs.next();
            // ce vai dar a coisa que tem que substituir o que
            // vc quer dar replace
            jrs.updateString("nome", "William");
            // agr vc atualiza, garota <3
            jrs.updateRow();
            // só pra jogar na cara ala
    ...
    // CachedRowSet: fecha a conexão automaticamente (me pede
    // explicação n, são 7:40 da manhã e to virada)
    public static void updateRowSetCached (Comprador comprador) {
        ...
        try {
            ...
            crs.updateRow();
            // ainda tem metodo pra aceitar as mudanças
            // ó que lindo
            crs.acceptChanges();
            System.out.println("Registro atualizado com sucesso");
        } catch (SQLException e){
    ...
    public static List<Comprador> searchByName(String nome) {
        ...
        String selectAllFrom = "SELECT id, nome, cpf FROM agencia.comprador WHERE nome LIKE '%" + nome + "%';";
        // conectar o java com o banco de dados
        Connection conn = ConexaoFactory.getConexao();
        List<Comprador> compradorList = new ArrayList<>();
        try {
    ...
    public static List<Comprador> searchByNamePreparedStatement(String nome) {
        ...
        // aberto para ser substituído por um dado adicionado posteriormente
    ...
    // Para pegar metadados (quantidade de colunas, nome delas, etc)
    ...
    public static void testTypeScroll() {
        ...
        try {
            ...
            System.out.println("De volta à primeira linha?: " + resultSet.first());
            System.out.println("Numero da linha atual: " + resultSet.getRow());

            // ou, também tem o método absolute(), que vai pra linha que tu quiser
            System.out.println("De volta à primeira linha com o absolute?: " + resultSet.absolute(4));
            System.out.println("Numero da linha atual: " + resultSet.getRow());
    ...
    public static void updateNomesToLowerCase() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                // 2 vezes ou mais, esse método cancela as alterções feitas
                // com update
