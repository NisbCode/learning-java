...
public class LinkedTransferQueue {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println(tq.add("Melanie"));
        ...
        System.out.println(tq.offer("Melanie"));

        // offer() sobrecarregado, checa se um item foi adicionado
        // dentro de algum espaço de tempo
        System.out.println(tq.offer("Melanie", 10, TimeUnit.SECONDS));
...
//        tq.transfer("Devdojo");
        ...
        // Para ver a capacidade do TransferQueue
